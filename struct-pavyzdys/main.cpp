...
int main() {
    ...
    for(int i = 0; i < kiekis; i++) {
        ...
        cout<<endl;
        cout<<"Kokiame mieste yra isikurus komanda?"<<endl;
    ...
    for (int i = 0; i < kiekis; i++) {
        cout<<"Komanda "<<komandos[i].pavadinimas<<" yra is "<<komandos[i].miestas<<endl;
    }

    cout<<"--------------Trynimas-------------"<<endl;
    cout<<"Kuria komanda norite istrinti?"<<endl;
    cin>>trinamasElem;
    ...
    cout<<"Kokios komandos ieskote sarase?"<<endl;
    cin>>ieskomaKomanda;

    for(int i = 0; i < kiekis; i++) {
        if(komandos[i].pavadinimas == ieskomaKomanda) {
            string rez = komandos[i].zaidziaEurolygoje == 1 ? "zaidzia" : "nezaidzia";
            cout<<"Informacija apie komanda: "<<komandos[i].pavadinimas<<" "<<komandos[i].miestas<<
                " "<<rez<<endl;
        }
    }
